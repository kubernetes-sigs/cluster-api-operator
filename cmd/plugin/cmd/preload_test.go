	...
	tests := []struct {
		...
		},
		{
			...
			publishOpts: &publishOptions{
				...
				providers: []publishProvider{{
					configMapName:  "core-cluster-api-v1.14.0",
					provider:       generateGenericProvider(clusterctlv1.CoreProviderType, "cluster-api", "default", "v1.14.0", "", ""),
		...
		},
		{
			...
			publishOpts: &publishOptions{
				...
				providers: []publishProvider{{
					configMapName:  "core-cluster-api-v1.14.0",
					provider:       generateGenericProvider(clusterctlv1.CoreProviderType, "cluster-api", "default", "v1.14.0", "", ""),
					metadataKey:    "core-cluster-api-v1.14.0-metadata.yaml",
					metadataData:   []byte("metadata"),
					componentsKey:  "core-cluster-api-v1.14.0-components.yaml",
					componentsData: []byte("components"),
				}, {
					configMapName:  "infrastructure-docker-v1.14.0",
					provider:       generateGenericProvider(clusterctlv1.InfrastructureProviderType, "docker", "default", "v1.14.0", "", ""),
					metadataKey:    "infrastructure-docker-v1.14.0-metadata.yaml",
					metadataData:   []byte("metadata"),
					componentsKey:  "infrastructure-docker-v1.14.0-components.yaml",
					componentsData: []byte("components"),
				}},
			},
		...
		},
		{
			...
			existingProviders: []genericprovider.GenericProvider{
				func() genericprovider.GenericProvider {
					p := generateGenericProvider(clusterctlv1.InfrastructureProviderType, "docker", "default", "v1.14.0", "", "")
					spec := p.GetSpec()
		...
		},
		{
			...
			existingProviders: []genericprovider.GenericProvider{
				generateGenericProvider(clusterctlv1.CoreProviderType, "cluster-api", "default", "v1.14.0", "", ""),
				generateGenericProvider(clusterctlv1.InfrastructureProviderType, "docker", "default", "v1.14.0", "", ""),
			},
			expectedConfigMaps: 2,
		},
		{
			...
			publishOpts: &publishOptions{
				...
				providers: []publishProvider{{
					configMapName:  "core-cluster-api-v1.14.0",
					provider:       generateGenericProvider(clusterctlv1.InfrastructureProviderType, "metadata-missing", "default", "v1.14.0", "", ""),
		...
		},
		{
			...
			publishOpts: &publishOptions{
				...
				providers: []publishProvider{{
					configMapName:  "core-cluster-api-v1.14.0",
					provider:       generateGenericProvider(clusterctlv1.InfrastructureProviderType, "components-missing", "default", "v1.14.0", "", ""),
					metadataKey:    "metadata.yaml",
					metadataData:   []byte("test"),
